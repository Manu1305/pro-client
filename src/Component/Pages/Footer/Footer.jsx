          ...
          <div className={styles.twoOne}>
            ...
            <div className={styles.iconsmain}>
              <div className={styles.icon}>
                {" "}
                <Link to="https://www.facebook.com/Hitecmart1">
                  <FaFacebookF />
                </Link>
              </div>
              <div className={styles.icon}>
                <Link to="https://www.instagram.com/hitecmart/">
                  <BsInstagram />
                </Link>
              </div>
              <div className={styles.icon}>
                <Link to="https://twitter.com/hitecmart/">
                  {" "}
                  <ImTwitter />
                </Link>
              </div>
              <div className={styles.icon}>
                <Link to="https://www.linkedin.com/company/hitech-mart/">
                  <FaLinkedinIn />
                </Link>
              </div>
            </div>
            ...
            <div className={styles.listmain}>
              ...
              <div className={styles.list}>
                <ul className={styles.listul}>
                  ...
                  <Link to="/sizeChart" className={styles.links}>
                    Size Guide
                  </Link>
              ...
              <div className={styles.list}>
                <ul className={styles.listul}>
                  ...
                  <Link to="/termsCond" className={styles.links}>
                    Terms and conditions{" "}
                  </Link>
                  <Link to="/privacyPol" className={styles.links}>
                    Privacy and policy
                  </Link>
                  <Link to="/sellerTermAndCond" className={styles.links}>
                    Retailer Terms
                  </Link>
                </ul>
              </div>
