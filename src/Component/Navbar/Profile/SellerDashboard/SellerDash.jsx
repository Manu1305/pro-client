...
import UserTable, { ReverseWithdrawSec } from "./ReverseWithdraw/ReverseWithdrawSec";
      ...
      <div className={dash.body}>
        ...
        >
          ...
          {selectedLoginType === "order0" && (
            <div className={dash["product-login"]} style={{marginLeft:"200px"}}>
              <SellerOrder />
            </div>
          )}
          {selectedLoginType === "order" && (
            <div className={dash["order-login"]} style={{marginLeft:"200px"}} >
              <OrderSec />
            </div>
          )}
